...
```
$ curl -d '{"method": "spreadsheet", "emails": "email@gmail.com" Mayors Office of the CTO"}' -H 'Content-Type: application/json' "https://ctofeedback.azurewebsites.net/api/setup"
```
