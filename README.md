...
- [[NYC MoCTO Feedback Module](#nyc-mocto-feedback-module)](#-nyc-mocto-feedback-module---nyc-mocto-feedback-module-)
- [[About the code](#about-the-code)](#-about-the-code---about-the-code-)
  - [[`feedback-module`](#feedback-module)](#--feedback-module----feedback-module-)
  - [[`backend`](#backend-stub)](#--backend----backend-stub-)
  - [[`homepage`](#homepage)](#--homepage----homepage-)
- [[Initial setup for agency webmasters](#initial-setup-for-agency-webmasters)](#-initial-setup-for-agency-webmasters---initial-setup-for-agency-webmasters-)
  - [[Setup via the command line interface](#setup-via-the-command-line-interface)](#-setup-via-the-command-line-interface---setup-via-the-command-line-interface-)
    - [[`emails`](#emails)](#--emails----emails-)
    - [[`agency`](#agency)](#--agency----agency-)
  - [[Spreadsheets](#spreadsheets)](#-spreadsheets---spreadsheets-)
    - [[Organization of feedback](#organization-of-feedback)](#-organization-of-feedback---organization-of-feedback-)
- [[Embedding the module in your website](#embedding-the-module-in-your-website)](#-embedding-the-module-in-your-website---embedding-the-module-in-your-website-)
  - [[Static Website](#static-website)](#-static-website---static-website-)
  ...
  - [[Attributes](#attributes)](#-attributes---attributes-)
    ...
    - [[gaID](#gaid)](#-gaid---gaid-)
    - [[`theme` (optional)](#theme-optional)](#--theme---optional----theme-optional-)
- [[Setting up your own instance of the module](#setting-up-your-own-instance-of-the-module)](#-setting-up-your-own-instance-of-the-module---setting-up-your-own-instance-of-the-module-)
  - [[System Requirements](#system-requirements)](#-system-requirements---system-requirements-)
    - [[Docker](#docker)](#-docker---docker-)
    - [[Excel Spreadsheet Templates](#excel-spreadsheet-templates)](#-excel-spreadsheet-templates---excel-spreadsheet-templates-)
    - [[Google Sheets Spreadsheet Templates](#google-sheets-spreadsheet-templates)](#-google-sheets-spreadsheet-templates---google-sheets-spreadsheet-templates-)
    - [[Microsoft Flow](#microsoft-flow)](#-microsoft-flow---microsoft-flow-)
    - [Google Drive API (#google-drive-api)](#google-drive-api---google-drive-api-)
    - [Azure (#azure)](#azure---azure-)
  - [[Installation](#installation)](#-installation---installation-)
  - [[Configuration](#configuration)](#-configuration---configuration-)
  - [[Building the module locally](#building-the-module-locally)](#-building-the-module-locally---building-the-module-locally-)
  - [[Testing the local build of your module](#testing-the-local-build-of-your-module)](#-testing-the-local-build-of-your-module---testing-the-local-build-of-your-module-)
    - [Static website (`.html`) (#static-website-html)](#static-website---html-----static-website-html-)
    - [[React](#react)](#-react---react--1)
  - [[Key features](#key-features)](#-key-features---key-features-)
    - [[Common Components](#common-components)](#-common-components---common-components-)
    - [[Constants](#constants)](#-constants---constants-)
  - [[Objects](#objects)](#-objects---objects-)
    - [[Feedback Type Object](#feedback-type-object)](#-feedback-type-object---feedback-type-object-)
    - [Input Response Object (#input-response-object)](#input-response-object---input-response-object-)
    - [Form Response Object (#form-response-object)](#form-response-object---form-response-object-)
  - [[API](#api)](#-api---api-)
    - [[`/api/feedback`](#api-feedback-post) `POST`](#---api-feedback----api-feedback-post---post-)
    - [[`/api/userResearch`](#api-userresearch-post) `POST`](#---api-userresearch----api-userresearch-post---post-)
    - [[`/api/setup`](#api-setup-post) `POST`](#---api-setup----api-setup-post---post-)
  - [[Updating the Module](#updating-the-module)](#-updating-the-module---updating-the-module-)
    - [[Adding Languages for Internationalization](#adding-languages-for-internationalization)](#-adding-languages-for-internationalization---adding-languages-for-internationalization-)
    - [[Adding a Screen](#adding-a-screen)](#-adding-a-screen---adding-a-screen-)
    - [[Updating the Module’s Questions](#updating-the-module’s-questions)](#-updating-the-module-s-questions---updating-the-module-s-questions-)
    - [[Changing Styles](#changing-styles)](#-changing-styles---changing-styles-)
    - [[Theming](#theming)](#-theming---theming-)
    - [[Style Overrides](#style-overrides)](#-style-overrides---style-overrides-)
    - [[Exporting Styles](#exporting-styles)](#-exporting-styles---exporting-styles-)
  - [[Publishing module updates](#publishing-module-updates)](#-publishing-module-updates---publishing-module-updates-)
- [[Google Analytics Tracking](#google-analytics-tracking)](#-google-analytics-tracking---google-analytics-tracking-)
  - [[What we are tracking](#what-we-are-tracking)](#-what-we-are-tracking---what-we-are-tracking-)
  - [[Pageview](#pageview)](#-pageview---pageview-)
  - [[Events](#events)](#-events---events-)
  - [Updating tracking events (#updating-tracking-events)](#updating-tracking-events---updating-tracking-events-)
...
![spreadsheet setup](images/image1.jpg "image_tooltip")
...
![Spreadsheet template example file](images/image2.png "image_tooltip")
...
3. In the top-left of the main interface, click “Import”.
   ![Microsoft Flow import page](images/image3.jpg "image_tooltip")
...
7. Click on your connection, or create a new one by clicking “Create new,” and press “Save.” Repeat until all related resources have green check marks next to them.
   ![Microsoft Flow new connection](images/image4.jpg "image_tooltip")
8. Click on “Open Flow”
   ![Microsoft Flow open flow link](images/image5.jpg "image_tooltip")
...
2. Create a new project by clicking “Select a project” and then “New project”
   ![Creating a new Google Drive API project](images/image6.jpg "image_tooltip")
