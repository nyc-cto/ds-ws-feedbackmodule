...
var BUTTON_STYLE="flex-align-self-start text-left border-transparent hover:bg-primary-light hover:text-primary hover:border-primary padding-10px mobile-lg:padding-x-205 mobile-lg:padding-y-2 mobile-lg:font-sans-lg border-05 hover:border-bottom-05 shadow-btn margin-y-1 mobile-lg:margin-y-2";var BUTTON_RIGHT_STYLE="flex-align-self-end";var CHECKBOX_STYLE="text-primary bg-transparent mobile-lg:font-sans-xl font-sans-md  margin-y-2";var HEADER_STYLE="radius-top-lg bg-primary height-4 mobile-lg:height-6 display-flex padding-x-10px padding-9px mobile-lg:padding-x-2 mobile-lg:padding-y-105 font-sans-check";var MODULE_CONTAINER_STYLE="bg-primary-light radius-top-lg padding-x-0";var SCREEN_CONTAINER_STYLE="padding-x-6 padding-y-5 overflow-hidden";var LABEL_STYLE="text-primary mobile-lg:font-sans-2xl font-sans-lg maxw-none margin-y-3";var TEXTAREA_STYLE="border-05 border-primary bg-primary-light focus:border-width-6px focus:bg-primary-lighter";var TEXTINPUT_STYLE="height-auto ".concat(TEXTAREA_STYLE);var FORM_STYLE="maxw-none overflow-hidden display-flex flex-column flex-align-stretch";var H1_STYLE="text-bold mobile-lg:font-sans-xl font-sans-lg margin-y-3";var H1_WHITE_STYLE="text-white ".concat(H1_STYLE);
// CONCATENATED MODULE: ./src/assets/constants.js
var SCREENS={feedback_type:{title:"feedbackType.title",buttons:[{type:"form",text:"missing.initialBtn",nextScreen:"missing_info",feedbackID:"data1"},{type:"form",text:"broken.initialBtn",nextScreen:"broken",feedbackID:"data2"},{type:"form",text:"other.initialBtn",nextScreen:"other",feedbackID:"data3"}]},missing_info:{title:"missing.title",checkboxes:"missing.checkboxes",textInputs:"missing.textInputs",formID:"feedback",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},broken:{title:"broken.title",checkboxes:"broken.checkboxes",textInputs:"broken.textInputs",formID:"feedback",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},other:{title:"other.title",textInputs:"other.textInputs",formID:"feedback",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},feedback_results:{titleInverse:"feedbackResults.title",plainText:"feedbackResults.plainText",buttons:[{type:"submit",text:"feedbackResults.button",nextScreen:"user_research"}]},user_research:{title:"userResearch.title",plainText:"userResearch.plainText",textInputs:"userResearch.textInputs",formID:"research",buttons:[{type:"submit",text:"submitBtn",nextScreen:"user_feedback_result"}]},user_feedback_result:{titleInverse:"userFeedbackResults.title"}};
...
function Textbox(_ref){var id=_ref.id,type=_ref.type,label=_ref.label,className=_ref.className,onChange=_ref.onChange;return type==="textarea"?/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Label"],{className:"".concat(className," ").concat(LABEL_STYLE),htmlFor:id,children:label}),/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Textarea"],{id:id,name:label,className:TEXTAREA_STYLE,onChange:onChange})]}):/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Label"],{className:"".concat(className," ").concat(LABEL_STYLE),htmlFor:id,children:label}),/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["TextInput"],{id:id,name:label,type:type,className:"".concat(className," ").concat(TEXTINPUT_STYLE),onChange:onChange})]});}/* harmony default export */ var common_Textbox = (Textbox);
// CONCATENATED MODULE: ./src/components/CheckboxList.js
function CheckboxList(_ref){var feedbackCheckboxes=_ref.feedbackCheckboxes,onCheck=_ref.onCheck,setOtherField=_ref.setOtherField;var _useState=Object(react["useState"])(false),_useState2=_slicedToArray(_useState,2),otherChecked=_useState2[0],setOtherChecked=_useState2[1];var onCheckOther=function onCheckOther(index,label){label==="Other"&&setOtherChecked(!otherChecked);onCheck(index);};var onChangeOther=function onChangeOther(_ref2){var target=_ref2.target;setOtherField(target.value);};return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{children:feedbackCheckboxes.map(function(label,index){return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{row:true,className:"flex-align-baseline",children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(Checkbox,{id:"checkbox-".concat(index),label:label,onCheck:function onCheck(){return onCheckOther(index,label);}}),otherChecked&&label==="Other"&&/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{col:"6",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Textbox,{id:"other-field",type:"text",className:"margin-left-1",onChange:onChangeOther})})]},index);})});}/* harmony default export */ var components_CheckboxList = (CheckboxList);
// CONCATENATED MODULE: ./src/components/TextboxList.js
function TextboxList(_ref){var inputs=_ref.inputs,inputQuestions=_ref.inputQuestions,setInputQuestions=_ref.setInputQuestions,className=_ref.className;console.log(inputs);var onChange=function onChange(_ref2){var target=_ref2.target;var answers=inputQuestions;answers[target.id].answer=target.value;setInputQuestions(answers);};return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{children:inputs.map(function(input,index){return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{col:"fill",className:className,children:/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Textbox,{id:index,type:input.type,label:input.text,onChange:onChange})},index);})});}/* harmony default export */ var components_TextboxList = (TextboxList);
// CONCATENATED MODULE: ./src/components/Module.js
/* eslint-disable no-unused-vars */function LightContainer(_ref){var children=_ref.children,formID=_ref.formID;var isChildNull=function isChildNull(children){/* returns true if there are no elements outside of the form element
       and the form is empty */return!(react_default.a.Children.toArray(children).length>1||formID);};return isChildNull(children)?children:/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{className:SCREEN_CONTAINER_STYLE,children:children});}function Module(_ref2){var pageTitle=_ref2.pageTitle;var _useState=Object(react["useState"])({}),_useState2=_slicedToArray(_useState,2),feedbackForAPI=_useState2[0],setFeedbackForAPI=_useState2[1];var _useState3=Object(react["useState"])({}),_useState4=_slicedToArray(_useState3,2),userInfo=_useState4[0],setUserInfo=_useState4[1];var _useState5=Object(react["useState"])(SCREENS.feedback_type),_useState6=_slicedToArray(_useState5,2),screen=_useState6[0],setScreen=_useState6[1];var _useState7=Object(react["useState"])(null),_useState8=_slicedToArray(_useState7,2),checkedFields=_useState8[0],setCheckedFields=_useState8[1];var _useState9=Object(react["useState"])(""),_useState10=_slicedToArray(_useState9,2),otherField=_useState10[0],setOtherField=_useState10[1];var _useState11=Object(react["useState"])(),_useState12=_slicedToArray(_useState11,2),inputQuestions=_useState12[0],setInputQuestions=_useState12[1];// const [hasChildren, setHasChildren] = useState(true);
var _useTranslation=useTranslation(),t=_useTranslation.t;Object(react["useEffect"])(function(){// Updates the checkboxes based on the new screen
t(screen.checkboxes)&&setCheckedFields(t(screen.checkboxes).map(function(checkboxLabel){return{label:checkboxLabel,checked:false};}));// Updates the text inputs based on the new screen
t(screen.textInputs)&&setInputQuestions(t(screen.textInputs).map(function(question){return{question:question.text,answer:""};}));// TODO: after merging with dev, this will send data to backend instead of just console.log
console.log(feedbackForAPI);console.log(userInfo);},[screen]);// updateFormData determines which form data state to update, based on the formID
var updateFormData=function updateFormData(formID){if(formID==="feedback"){/* if formID is feedback, sets checkedOptions and inputResponses 
         in the feedbackForAPI object */setFeedbackForAPI(function(feedback){/* filters checkedOptions for the fields that are checked,
           then returns only the label property */checkedFields&&(feedback.checkedOptions=checkedFields.filter(function(_ref3){var checked=_ref3.checked;return checked;}).map(function(_ref4){var label=_ref4.label;return label;}));feedback.inputResponses=inputQuestions;return feedback;});}else if(formID==="research"){setUserInfo(inputQuestions);}};// Updates the label to "Other: <user-input other content>" if other field is checked
var updateOtherField=function updateOtherField(checkedFields){checkedFields.forEach(function(field){//TODO: this should not check if the label is other because this could get confusing with translations
field.label==="Other"&&field.checked&&(field.label="Other: ".concat(otherField));});return checkedFields;};var handleSubmit=function handleSubmit(){setCheckedFields(checkedFields&&updateOtherField(checkedFields));updateFormData(screen.formID);};var changeScreen=function changeScreen(text,nextScreen,feedbackID){// If button contains a feedbackID, update the feedbackType of the feedback object
if(feedbackID){setFeedbackForAPI(function(feedback){feedback.feedbackType={label:text,feedbackID:feedbackID};return feedback;});}// Submit form data if this screen contains a form
screen.formID&&handleSubmit();setScreen(SCREENS[nextScreen]);};var _onCheck=function onCheck(index){setCheckedFields(function(checked){checked[index].checked=!checked[index].checked;return checked;});};return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["GridContainer"],{desktop:{col:2},mobile:{col:"fill"},className:MODULE_CONTAINER_STYLE,children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Header,{}),screen.titleInverse&&/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{className:"bg-primary ".concat(SCREEN_CONTAINER_STYLE),children:/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{className:"".concat(H1_WHITE_STYLE),dangerouslySetInnerHTML:{__html:t(screen.titleInverse)}})}),/*#__PURE__*/Object(jsx_runtime["jsxs"])(LightContainer,{formID:screen.formID,children:[screen.title&&/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{className:H1_STYLE,children:t(screen.title,{page:pageTitle})}),screen.plainText&&/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{dangerouslySetInnerHTML:{__html:t(screen.plainText)}}),/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Form"],{className:FORM_STYLE,onSubmit:function onSubmit(e){return e.preventDefault();},children:[screen.checkboxes&&/*#__PURE__*/Object(jsx_runtime["jsx"])(components_CheckboxList,{feedbackCheckboxes:t(screen.checkboxes),onCheck:function onCheck(index){return _onCheck(index);},setOtherField:setOtherField}),screen.textInputs&&/*#__PURE__*/Object(jsx_runtime["jsx"])(components_TextboxList,{inputs:t(screen.textInputs),setInputQuestions:setInputQuestions,inputQuestions:inputQuestions}),screen.buttons&&screen.buttons.map(function(_ref5,index){var type=_ref5.type,text=_ref5.text,nextScreen=_ref5.nextScreen,feedbackID=_ref5.feedbackID;return/*#__PURE__*/Object(jsx_runtime["jsx"])(Button,{buttonText:t(text),isRight:type==="submit",onClick:function onClick(){return changeScreen(text,nextScreen,feedbackID);}},index);})]})]})]});}/* harmony default export */ var components_Module = (Module);
// CONCATENATED MODULE: ./src/App.js
function App(_ref){var lang=_ref.lang,pageTitle=_ref.pageTitle;var _useTranslation=useTranslation(),i18n=_useTranslation.i18n;Object(react["useEffect"])(function(){i18n.changeLanguage(lang);},[lang]);return/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{className:"App",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(components_Module,{pageTitle:pageTitle})});}/* harmony default export */ var src_App = (App);
// CONCATENATED MODULE: ./src/index.js
var WidgetDivs=document.querySelectorAll("#feedback-widget");WidgetDivs.forEach(function(Div){var currentLang="en";var pageTitle="";Div.attributes.lang&&(currentLang=Div.attributes.lang.value);Div.attributes.pageTitle&&(pageTitle=Div.attributes.pageTitle.value);react_dom_default.a.render(/*#__PURE__*/Object(jsx_runtime["jsx"])(react_default.a.StrictMode,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(react["Suspense"],{fallback:"... is loading",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(src_App,{domElement:Div,lang:currentLang,pageTitle:pageTitle})})}),Div);});// If you want to start measuring performance in your app, pass a function
