...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return hasXMLHttpRequest; });
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "static/media/getFetch.582d29c4.cjs");
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var _getFetch_cjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
function _typeof(obj) {
  "@babel/helpers - typeof";
...
if (_utils_js__WEBPACK_IMPORTED_MODULE_0__[/* hasXMLHttpRequest */ "b"]) {
...
if (!fetchApi && _getFetch_cjs__WEBPACK_IMPORTED_MODULE_1__ && !XmlHttpRequestApi && !ActiveXObjectApi) fetchApi = _getFetch_cjs__WEBPACK_IMPORTED_MODULE_1__["default"] || _getFetch_cjs__WEBPACK_IMPORTED_MODULE_1__;
...
var requestWithFetch = function requestWithFetch(options, url, payload, callback) {
  ...
  var headers = Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__[/* defaults */ "a"])({}, typeof options.customHeaders === 'function' ? options.customHeaders() : options.customHeaders);
  if (payload) headers['Content-Type'] = 'application/json';
  fetchApi(url, Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__[/* defaults */ "a"])({
...
var request = function request(options, url, payload, callback) {
  ...
  if (_utils_js__WEBPACK_IMPORTED_MODULE_0__[/* hasXMLHttpRequest */ "b"] || typeof ActiveXObject === 'function') {
...
// EXTERNAL MODULE: ./node_modules/@trussworks/react-uswds/lib/index.css
...
// EXTERNAL MODULE: ./node_modules/i18next-http-backend/esm/utils.js
var utils = __webpack_require__(3);

// EXTERNAL MODULE: ./node_modules/i18next-http-backend/esm/request.js
...
function esm_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) esm_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) esm_defineProperties(Constructor, staticProps);
  return Constructor;
}
...
var esm_Backend = function () {
  ...
  esm_createClass(Backend, [{
    ...
    value: function init(services) {
      ...
      var allOptions = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      this.services = services;
      this.options = Object(utils["a" /* defaults */])(options, this.options || {}, esm_getDefaults());
      this.allOptions = allOptions;
...
esm_Backend.type = 'backend';
/* harmony default export */ var esm = (esm_Backend);
// CONCATENATED MODULE: ./src/i18n.js
esm_i18next// i18next-http-backend
// loads translations from your server
// https://github.com/i18next/i18next-http-backend
.use(esm)// detect user language
// learn more: https://github.com/i18next/i18next-browser-languageDetector
.use(i18nextBrowserLanguageDetector)// pass the i18n instance to react-i18next.
.use(initReactI18next)// init i18next
// for all options read: https://www.i18next.com/overview/configuration-options
.init({debug:true,fallbackLng:"en",interpolation:{escapeValue:false// not needed for react as it escapes by default
},returnObjects:true});/* harmony default export */ var src_i18n = (esm_i18next);
...
function useTranslation(ns) {
  ...
  var i18nOptions = useTranslation_objectSpread(useTranslation_objectSpread(useTranslation_objectSpread({}, context_getDefaults()), i18n.options.react), props);
...
var react_uswds_lib = __webpack_require__(2);

// CONCATENATED MODULE: ./src/assets/styling_classnames.js
var BUTTON_STYLE="text-left border-transparent hover:bg-primary-light hover:text-primary hover:border-primary padding-10px mobile-lg:padding-x-205 mobile-lg:padding-y-2 mobile-lg:font-sans-lg border-05 hover:border-bottom-05 shadow-btn margin-y-1 mobile-lg:margin-y-2";var BUTTON_RIGHT_STYLE="float-right margin-x-0 clear-both";var CHECKBOX_STYLE="text-primary bg-transparent mobile-lg:font-sans-xl font-sans-md  margin-y-2";var HEADER_STYLE="radius-top-lg bg-primary height-4 mobile-lg:height-6 display-flex padding-x-10px padding-9px mobile-lg:padding-x-2 mobile-lg:padding-y-105 font-sans-check";var MODULE_CONTAINER_STYLE="bg-primary-light radius-top-lg padding-x-0";var SCREEN_CONTAINER_STYLE="padding-x-6 padding-y-5 overflow-hidden";var LABEL_STYLE="text-primary mobile-lg:font-sans-2xl font-sans-lg maxw-none margin-y-3";var TEXTAREA_STYLE="border-05 border-primary bg-primary-light focus:border-width-6px focus:bg-primary-lighter";var TEXTINPUT_STYLE=TEXTAREA_STYLE;
// CONCATENATED MODULE: ./src/assets/header_logo.png
/* harmony default export */ var header_logo = ("data:image/png;base64,");
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(0);

// CONCATENATED MODULE: ./src/components/common/Header.js
function Header(){return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["GridContainer"],{className:HEADER_STYLE,children:/*#__PURE__*/Object(jsx_runtime["jsx"])("img",{src:header_logo,alt:"New York City feedback module logo"})});}/* harmony default export */ var common_Header = (Header);
// CONCATENATED MODULE: ./src/components/common/Button.js
function ModuleButton(_ref){var buttonText=_ref.buttonText,onClick=_ref.onClick,isRight=_ref.isRight,className=_ref.className;return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Button"],{"aria-label":buttonText,onClick:onClick,className:"".concat(className," ").concat(isRight&&BUTTON_RIGHT_STYLE," ").concat(BUTTON_STYLE),children:buttonText});}/* harmony default export */ var Button = (ModuleButton);
// CONCATENATED MODULE: ./src/assets/constants2.js
var MISSING_INFO={title:"Sorry you couldn't find what you were looking for! Can you tell us a little more?",checkboxes:["I wasn't sure where to look","I was confused by the information I found","I don't understand how to use this website","I hit a dead end","The content was not available in my preferred language","There were errors with the translation available","Other"],textInputs:[{type:"text",text:"What were you looking for or trying to do?"},{type:"text",text:"Would you like to add anything else?"}],button:"Submit"};var BROKEN={title:"Sorry to hear that something is broken or inaccurate! Can you tell us a little more?",checkboxes:["There is a spelling mistake or typo","A link or button does not work","The information is out of date","I got different informatino from another source (311, printed mailer, elected official, etc.)","The layout looks broken","I got an error","Other"],textInputs:[{type:"text",text:"Can you give us more details on what you were trying to do, or the exact problem you encountered? (optional)"}],button:"Submit"};var OTHER={title:"We appreciate your feedback.",checkboxes:[],textInputs:[{type:"text",text:"Can you tell us a little more?"}],button:"Submit"};var SCREEN1_BUTTONS=[{text:"I couldn’t find what I was looking for",data:MISSING_INFO},{text:"Something appears to be broken or inaccurate",data:BROKEN},{text:"I have other feedback on this page or website",data:OTHER}];var SUBMISSION_TEXT={msg_line1:"Thank you for your feedback! It has been submitted.",msg_line2:"Your feedback is anonymous and confidential, so you will not receive a reply. ",user_research:"The City of New York is always trying to improve its services. Are you interesed in being a user research participant? This is is entirely voluntary and you can opt out at any time. Signing up to be a user research participant will have no impact on your feedback today, or your eligibility to access or receive services in the future.",button_text:"Yes, sign me up!"};var USER_RESEARCH_FORM={title:"As a user research participant you can help us continue to improve services for New Yorkers",summaryText:"Please leave your contact details and we will get in touch with you. Being a research participant means you may be contacted from time to time to help us test new services and products. We will send you an email with more details.",furtherInfoText:"You can opt out at any time.",form:[{type:"text",text:"Your name"},{type:"email",text:"Your email"},{type:"tel",text:"Your phone number"}],buttonText:"Submit"};
// CONCATENATED MODULE: ./src/assets/constants.js
var SCREENS={feedback_type:{buttons:[{type:"form",text:"missing.initialBtn",nextScreen:"missing_info",feedbackID:"data1"},{type:"form",text:"broken.initialBtn",nextScreen:"broken",feedbackID:"data2"},{type:"form",text:"other.initialBtn",nextScreen:"other",feedbackID:"data3"}]},missing_info:{title:"missing.title",checkboxes:"missing.checkboxes",textInputs:"missing.textInputs",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},broken:{title:"broken.title",checkboxes:"broken.checkboxes",textInputs:"broken.textInputs",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},other:{title:"other.title",textInputs:"other.textInputs",buttons:[{type:"submit",text:"submitBtn",nextScreen:"feedback_results"}]},feedback_results:{titleInverse:"feedbackResults.itle",plain_text:"feedbackResults.plain_text",buttons:[{type:"submit",text:"feedbackResults.button",nextScreen:"user_research"}]},user_research:{title:"userResearch.title",plain_text:"userResearch.plain_text",textInputs:"userResearch.textInputs",buttons:[{type:"submit",text:"submitBtn",nextScreen:"user_feedback_result"}]},user_feedback_result:{titleInverse:"userFeedbackResults.title"}};
// CONCATENATED MODULE: ./src/components/common/Textbox.js
function Textbox(_ref){var id=_ref.id,size=_ref.size,type=_ref.type,label=_ref.label,className=_ref.className,onChange=_ref.onChange;return size==="area"?/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Label"],{className:"".concat(className," ").concat(LABEL_STYLE),htmlFor:id,children:label}),/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Textarea"],{id:id,name:label,className:TEXTAREA_STYLE,onChange:onChange})]}):/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Label"],{className:"".concat(className," ").concat(LABEL_STYLE),htmlFor:id,children:label}),/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["TextInput"],{id:id,name:label,type:type,className:"".concat(className," ").concat(TEXTINPUT_STYLE),onChange:onChange})]});}/* harmony default export */ var common_Textbox = (Textbox);
// CONCATENATED MODULE: ./src/components/TextboxList.js
function TextboxList(_ref){var inputs=_ref.inputs,inputQuestions=_ref.inputQuestions,setInputQuestions=_ref.setInputQuestions,size=_ref.size,className=_ref.className;var onChange=function onChange(_ref2){var target=_ref2.target;var answers=inputQuestions;answers[target.id].answer=target.value;setInputQuestions(answers);};return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{children:inputs.map(function(input,index){return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{col:"fill",className:className,children:/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Textbox,{id:index,size:size,type:input.type,label:input.text,onChange:onChange})},index);})});}/* harmony default export */ var components_TextboxList = (TextboxList);
// CONCATENATED MODULE: ./src/components/pages/Screen1.js
function Screen1(_ref){var changePage=_ref.changePage,page=_ref.page,setFeedback=_ref.setFeedback;var _useTranslation=useTranslation(),t=_useTranslation.t;var buttons=SCREEN1_BUTTONS.map(function(_ref2,index){var text=_ref2.text,data=_ref2.data;var handleClick=function handleClick(e){changePage(data);setFeedback(function(feedback){feedback.feedbackType=text;return feedback;});e.preventDefault();};return/*#__PURE__*/Object(jsx_runtime["jsx"])(Button,{buttonText:text,onClick:handleClick},index);});return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{className:SCREEN_CONTAINER_STYLE,children:[/*#__PURE__*/Object(jsx_runtime["jsxs"])("h1",{children:["Do you have any feedback on ",page,"?"]}),/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{children:t("test")}),buttons,/*#__PURE__*/Object(jsx_runtime["jsx"])(Button,{buttonText:t(SCREENS.feedback_type.buttons[0].text)}),";",console.log(t(SCREENS.broken.checkboxes)),console.log(t(SCREENS.missing_info.textInputs)),/*#__PURE__*/Object(jsx_runtime["jsx"])(components_TextboxList,{inputs:t(SCREENS.missing_info.textInputs),size:"area"})]});}/* harmony default export */ var pages_Screen1 = (Screen1);
// CONCATENATED MODULE: ./src/components/common/Checkbox.js
function ModuleCheckbox(_ref){var label=_ref.label,id=_ref.id,onCheck=_ref.onCheck;return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Checkbox"],{id:id,label:label,color:"primary",className:CHECKBOX_STYLE,onChange:onCheck});}/* harmony default export */ var Checkbox = (ModuleCheckbox);
// CONCATENATED MODULE: ./src/components/CheckboxList.js
function CheckboxList(_ref){var feedbackCheckboxes=_ref.feedbackCheckboxes,onCheck=_ref.onCheck,setOtherField=_ref.setOtherField;var _useState=Object(react["useState"])(false),_useState2=_slicedToArray(_useState,2),otherChecked=_useState2[0],setOtherChecked=_useState2[1];var onCheckOther=function onCheckOther(index,label){label==="Other"&&setOtherChecked(!otherChecked);onCheck(index);};var onChangeOther=function onChangeOther(_ref2){var target=_ref2.target;setOtherField(target.value);};return/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{children:feedbackCheckboxes.map(function(label,index){return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{row:true,className:"flex-align-baseline",children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(Checkbox,{id:index,label:label,onCheck:function onCheck(){return onCheckOther(index,label);}}),otherChecked&&label==="Other"&&/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{col:"6",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Textbox,{id:"label",size:"input",type:"text",className:"margin-left-1",onChange:onChangeOther})})]},index);})});}/* harmony default export */ var components_CheckboxList = (CheckboxList);
// CONCATENATED MODULE: ./src/components/pages/Screen2.js
function Screen2(_ref){var feedbackType=_ref.feedbackType,changePage=_ref.changePage,setFeedback=_ref.setFeedback;var _useState=Object(react["useState"])(feedbackType.checkboxes.map(function(checkboxLabel){return{label:checkboxLabel,checked:false};})),_useState2=_slicedToArray(_useState,2),checkedFields=_useState2[0],setCheckedFields=_useState2[1];var _useState3=Object(react["useState"])(""),_useState4=_slicedToArray(_useState3,2),otherField=_useState4[0],setOtherField=_useState4[1];var _useState5=Object(react["useState"])(feedbackType.textInputs.map(function(question){return{question:question,answer:""};})),_useState6=_slicedToArray(_useState5,2),inputQuestions=_useState6[0],setInputQuestions=_useState6[1];var _onCheck=function onCheck(index){var checked=checkedFields;checked[index].checked=!checked[index].checked;setCheckedFields(checked);};var onSubmit=function onSubmit(e){var checkedOptions=checkedFields.map(function(_ref2){var label=_ref2.label,checked=_ref2.checked;return{checked:checked,label:label==="Other"&&checked?"Other: ".concat(otherField):label};});setCheckedFields(checkedOptions);setFeedback(function(feedback){feedback.checkedOptions=checkedOptions.filter(function(_ref3){var checked=_ref3.checked;return checked;}).map(function(_ref4){var label=_ref4.label;return label;});feedback.inputResponses=inputQuestions;console.log(feedback);return feedback;});changePage();e.preventDefault();};return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{className:SCREEN_CONTAINER_STYLE,children:[/*#__PURE__*/Object(jsx_runtime["jsx"])("h1",{children:feedbackType.title}),/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Form"],{className:"maxw-none overflow-hidden",children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(components_CheckboxList,{feedbackCheckboxes:feedbackType.checkboxes,onCheck:function onCheck(label){return _onCheck(label);},setOtherField:setOtherField}),/*#__PURE__*/Object(jsx_runtime["jsx"])(components_TextboxList,{inputs:feedbackType.textInputs,setInputQuestions:setInputQuestions,inputQuestions:inputQuestions,size:"area"}),/*#__PURE__*/Object(jsx_runtime["jsx"])(Button,{buttonText:feedbackType.button,isRight:true,onClick:onSubmit})]})]});}/* harmony default export */ var pages_Screen2 = (Screen2);
// CONCATENATED MODULE: ./src/components/pages/Screen3.js
function Screen3(_ref){var changePage=_ref.changePage;return/*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"],{children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(react_uswds_lib["Grid"],{className:"bg-primary ".concat(SCREEN_CONTAINER_STYLE),children:/*#__PURE__*/Object(jsx_runtime["jsxs"])("h1",{className:"text-white",children:[SUBMISSION_TEXT.msg_line1,/*#__PURE__*/Object(jsx_runtime["jsx"])("br",{}),/*#__PURE__*/Object(jsx_runtime["jsx"])("br",{}),SUBMISSION_TEXT.msg_line2]})}),/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{className:SCREEN_CONTAINER_STYLE,children:[/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{children:SUBMISSION_TEXT.user_research}),/*#__PURE__*/Object(jsx_runtime["jsx"])(Button,{buttonText:SUBMISSION_TEXT.button_text,isRight:true,onClick:function onClick(){return changePage();}})]})]});}/* harmony default export */ var pages_Screen3 = (Screen3);
// CONCATENATED MODULE: ./src/components/pages/Screen4.js
function Screen4(){var _useState=Object(react["useState"])(USER_RESEARCH_FORM.form.map(function(question){return{question:question,response:""};})),_useState2=_slicedToArray(_useState,2),inputQuestions=_useState2[0],setInputQuestions=_useState2[1];var onSubmit=function onSubmit(e){console.log(inputQuestions);e.preventDefault();};return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Grid"],{className:SCREEN_CONTAINER_STYLE,children:[/*#__PURE__*/Object(jsx_runtime["jsx"])("h1",{children:USER_RESEARCH_FORM.title}),/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{className:"margin-bottom-0",children:USER_RESEARCH_FORM.summaryText}),/*#__PURE__*/Object(jsx_runtime["jsx"])("p",{className:"margin-top-0",children:USER_RESEARCH_FORM.furtherInfoText}),/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["Form"],{className:"maxw-none overflow-hidden",children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(components_TextboxList,{inputs:USER_RESEARCH_FORM.form,setInputQuestions:setInputQuestions,inputQuestions:inputQuestions,size:"input",className:"margin-bottom-5"}),/*#__PURE__*/Object(jsx_runtime["jsx"])(Button,{buttonText:USER_RESEARCH_FORM.buttonText,isRight:true,onClick:onSubmit})]})]});}/* harmony default export */ var pages_Screen4 = (Screen4);
// CONCATENATED MODULE: ./src/components/common/Module.js
function Module(){var _useState=Object(react["useState"])({}),_useState2=_slicedToArray(_useState,2),feedback=_useState2[0],setFeedback=_useState2[1];Object(react["useEffect"])(function(){console.log(feedback);},[feedback]);var _useState3=Object(react["useState"])(/*#__PURE__*/Object(jsx_runtime["jsx"])(pages_Screen1,{setFeedback:setFeedback,changePage:function changePage(data){return setScreen(/*#__PURE__*/Object(jsx_runtime["jsx"])(pages_Screen2,{feedbackType:data,setFeedback:setFeedback,changePage:function changePage(){return setScreen(/*#__PURE__*/Object(jsx_runtime["jsx"])(pages_Screen3,{changePage:function changePage(){return setScreen(/*#__PURE__*/Object(jsx_runtime["jsx"])(pages_Screen4,{}));}}));}}));},page:"[this page]"})),_useState4=_slicedToArray(_useState3,2),screen=_useState4[0],setScreen=_useState4[1];return/*#__PURE__*/Object(jsx_runtime["jsxs"])(react_uswds_lib["GridContainer"],{desktop:{col:2},mobile:{col:"fill"},className:MODULE_CONTAINER_STYLE,children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Header,{}),screen]});}/* harmony default export */ var common_Module = (Module);
// CONCATENATED MODULE: ./src/App.js
function App(_ref){var lang=_ref.lang;var _useTranslation=useTranslation(),i18n=_useTranslation.i18n;Object(react["useEffect"])(function(){i18n.changeLanguage(lang);},[lang]);return/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{className:"App",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(common_Module,{})});}/* harmony default export */ var src_App = (App);
// CONCATENATED MODULE: ./src/index.js
var WidgetDivs=document.querySelectorAll("#feedback-widget");WidgetDivs.forEach(function(Div){var currentLang="en";Div.attributes.lang&&(currentLang=Div.attributes.lang.value);react_dom_default.a.render(/*#__PURE__*/Object(jsx_runtime["jsx"])(react_default.a.StrictMode,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(react["Suspense"],{fallback:"... is loading",children:/*#__PURE__*/Object(jsx_runtime["jsx"])(src_App,{domElement:Div,lang:currentLang})})}),Div);});// If you want to start measuring performance in your app, pass a function
