...
const PROJECT_SASS_SRC = "./src/styles";

// Images destination
const IMG_DEST = "./src/styles/assets/img";

// Fonts destination
const FONTS_DEST = "./src/styles/assets/fonts";

// Javascript destination
const JS_DEST = "./src/styles/assets/js";

// Compiled CSS destination
const CSS_DEST = "./src/styles/assets/css";
...
gulp.task("css-namespace", function () {
  return gulp
    .src("src/styles/assets/css/*.css")
    .pipe(cssNamepsace({ namespace: "namespace-" }))
    .pipe(gulp.dest("src/styles/assets/dest"));
});

gulp.task("css-namespace-2", function () {
  return gulp
    .src("build/*.css")
    .pipe(cssNamepsace({ namespace: "feedback-" }))
