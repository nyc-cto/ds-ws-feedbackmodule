export const TRANSLATIONS_EN = {
  ...
  broken: {
    initialBtn: "Something appears to be broken or inaccurate",
    title:
  ...
  other: {
    initialBtn: "I have other feedback on this page or website",
  ...
  userResearch: {
    ...
    plainText:
      '<p>Please leave your contact details and we will get in touch with you. Being a research participant means you may be contacted from time to time to help us test new services and products. We will send you an email with more details.</p><p class="padding-top-2">You can opt out at any time.</p>',
    textInputs: [
