...
export const SCREEN_CONTAINER_STYLE =
  "padding-x-5 padding-y-205 overflow-hidden mobile-lg:padding-x-7 mobile-lg:padding-y-6 mobile-lg-padding-x-7 mobile-lg-padding-y-6";
...
export const TEXTAREA_STYLE =
  "text-primary border-05 border-primary bg-primary-light focus:border-width-6px focus:bg-primary-lighter focus-border-width-6px focus-bg-primary-lighter";
...
export const PLAINTEXT_STYLE =
  "mobile-lg:font-sans-lg mobile-lg-font-sans-lg font-sans-md line-height-sans-3 mobile-lg:line-height-sans-5 mobile-lg-line-height-sans-5 text-primary margin-top-0 text-no-uppercase";
