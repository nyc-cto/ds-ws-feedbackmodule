export const BUTTON_STYLE =
  "text-left border-transparent hover:bg-primary-light hover:text-primary hover:border-primary padding-10px mobile-lg:padding-x-205 mobile-lg:padding-y-2 mobile-lg:font-sans-lg border-05 hover:border-bottom-05 shadow-btn margin-y-1 mobile-lg:margin-y-2";
...
export const P_STYLE = "mobile-lg:font-sans-xl font-sans-md text-normal";
